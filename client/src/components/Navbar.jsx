    ...
    <nav className="fixed left-0 top-0 z-10 flex w-full flex-row justify-between bg-stone-700">
      <div className="p-2 text-center text-white">
        <Link to="/" className="mx-2">
          <i className="fa-solid fa-book text-4xl"></i> Album Booth
        </Link>
      </div>

      <div className="block sm:hidden">
        <button
          className={`flex items-center px-3 py-2 text-white transition-transform duration-700 ease-in-out ${
      ...
      <div
        ...
        } transition duration-700 sm:flex sm:flex-row sm:items-center`}
      >
        <ul className="flex flex-col sm:flex-row">
          ...
          <li className="px-4 py-2 text-center text-white hover:bg-stone-500">
            <Link to="/upload" onClick={handleMenuToggle}>
              Upload
            </Link>
          </li>
          <li className="px-4 py-2 text-center text-white hover:bg-stone-500">
            <Link to="/my-albums" onClick={handleMenuToggle}>
              My Albums
            </Link>
          </li>
